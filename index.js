...
const sendTgMsg = (user = "manishkumarrai") => {
  bot.telegram.sendMessage(
    "@leetcodermanish",
    `Attention Everybody\n\nManish Just Solved a new Question on leetcode.\n\nCurrent Stats: \nTotal Solved: ${latestData[0].count}\nEasy: ${latestData[1].count}\nMedium: ${latestData[2].count}\nHard: ${latestData[3].count}\n\nOn behalf of all the people in this community, I'm congratulating Manish for such a feat.`,
    Markup.inlineKeyboard([
      Markup.button.url(`Check Profile`, `leetcode.com/${user}`),
    ])
  );
};
